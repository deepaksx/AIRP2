# AIRP v2.0 - Database Initialization Script (Simple Version)
...
if (-not (Test-Path $ddlPath)) {
    Write-Host "ERROR: DDL file not found: $ddlPath" -ForegroundColor Red
    exit 1
}
...
Write-Host "OK: Database schema loaded successfully" -ForegroundColor Green
Write-Host ""
