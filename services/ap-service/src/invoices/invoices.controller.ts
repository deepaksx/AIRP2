...
export class InvoicesController {
  ...
  @Post(':id/classify')
  async classify(@Param('id') id: string, @Query('tenant_id') tenantId: string) {
    this.logger.log(`Classifying invoice ${id} with AI`);
    return this.invoicesService.classifyWithAI(id, tenantId);
  }
}
